    ...
    this.DOMSearchField =
        ...
        this.hideTimeout =
            setTimeout(this.name + ".CloseSelectionWindow()", this.closeSelectionTimeout);
                                            ...
                                            // Called when the content of the search field is
                                            // changed.
        ...
        for (i = 0; i < win.childNodes.length; i++) {
            ...
            if (child.className == 'SelectItem') {
                ...
                j++;
                                                        ...
                                                        // Called when an search filter selection is
                                                        // made. set item with index id as the
                                                        // active item
                                                        this.OnSelectItem =
                                                            function(id) {
        this.searchIndex = id;
        ...
        if (idx != -1) {
            ...
            resultsPage = this.resultsPath + '/' + indexSectionNames[this.searchIndex] + '_' +
                          hexCode + '.html';
